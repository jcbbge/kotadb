...
export async function parseSourceFile(
	...
	// Skip dependency extraction for SQL, Gleam, Erlang, Rust, Markdown, and TOML files
	const skipDeps = new Set([".sql", ".gleam", ".erl", ".rs", ".md", ".mdx", ".toml"]);
	const dependencies = skipDeps.has(extname(path)) ? [] : extractDependencies(content);
